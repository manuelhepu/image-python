...
try:
    ...
    get_ejecucion = """SELECT MAX(execution) FROM trivy_image WHERE image = %s"""
    ...
    for i in range(0, totalvuln):
        ...
        postgres_insert_query = """ INSERT INTO trivy_image (image, target, type, vid, package, installed, fixed, severity, url, execution, insertiondate) VALUES (%s, %s,%s,%s,%s,%s,%s,%s,%s,%s,%s) """
